...
export const firstBatch = [
    {
        ...
        isbn: '',
        publisher: 'Parental Africa Limited',
        marketer: 'Willibooks Limited',
        language: 'English',
        releaseYear: 2019,
        numberOfChapters: 10,
        numberOfPages: 155,
        price: 8,
        description: 'This book is also available on the willibooks app for just $1 monthly subscription'
    },
    {
        id: 2,
        imageUrl: confession,
...
export const stores = [
    {
        country: 'Uganda',
        locations: [ 'Kampala', 'Jinja', 'Mbale', 'Fort Portal', 'Gulu', 'Masaka' ]
    },
    {
        country: 'Kenya',
        locations: [ 'Nairobi', 'Mombasa', 'Nakuru', 'Eldoret' ]
    },
    {
        country: 'Ghana',
        locations: [ 'Accra', 'Kumasi', 'Takoradi', 'Cape Coast', 'Tamale' ]
    },
    {
    ...
    {
        country: 'Nigeria',
        locations: [ 'Abuja', 'Lagos', 'Kano', 'Ibadan', 'Port Harcourt','Benin' ]
    },
    {
        country: 'Botswana',
        locations: [ 'Gaborone', 'Francistown', 'Molepolele' ]
    },
    {
        country: 'Malawi',
